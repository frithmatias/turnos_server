...
const userSchema = new Schema({
    ...
    id_company: {type: Schema.Types.ObjectId, ref: 'Company', required: [true, 'El nombre de la empresa es necesario']},
    id_role: {type: String, required: true, default: 'USER_ROLE', enum: rolesValidos},
    id_skills: [{type: Schema.Types.ObjectId, ref: 'Skill' , required: false}],
