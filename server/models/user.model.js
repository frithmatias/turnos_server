...
const userSchema = new mongoose_1.Schema({
    ...
    id_company: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Company', required: [true, 'El nombre de la empresa es necesario'] },
    id_role: { type: String, required: true, default: 'USER_ROLE', enum: rolesValidos },
    id_skills: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'Skill', required: false }],
