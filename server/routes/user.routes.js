...
userRoutes.get('/testdata', user_controller_1.default.testData);
...
userRoutes.post('/attachcompany/:idUser', auth_1.default.verificaToken, user_controller_1.default.attachCompany);
